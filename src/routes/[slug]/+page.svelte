<script>
	// import client from '$lib/studio/sanityClient';
	...
	onMount(async () => {
		try {
			// GROQ query to fetch recipes with related cuisine and meal type data
...
<!-- src={`https://cdn.sanity.io/images/${import.meta.env.VITE_PUBLIC_SANITY_PROJECT_ID}/${import.meta.env.VITE_PUBLIC_SANITY_DATASET}/${recipe.mainImage.asset._ref.replace('image-', '').replace('-jpg', '.jpg')}`} -->
